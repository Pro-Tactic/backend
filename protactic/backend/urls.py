...
from .views import LoginView, LogoutView, NavigationView, CoachHomeView, ClubeViewSet, JogadorViewSet, CompeticaoViewSet, BuscaGlobalView, PartidaViewSet, GolViewSet, EscalacaoViewSet, DesempenhoViewSet, ClubeDashboardView, CompeticaoTimesView, CompeticaoClubeStatsView, TecnicoCreateView
...
urlpatterns = [
    ...
    path('tecnicos/', TecnicoCreateView.as_view(), name='tecnico_create'),
    ...
    path('clubes/<str:pk>/dashboard/', ClubeDashboardView.as_view())
]